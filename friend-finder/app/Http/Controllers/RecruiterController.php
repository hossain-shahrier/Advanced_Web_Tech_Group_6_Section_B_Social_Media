...
class RecruiterController extends Controller
{
    ...
    public function jobget(Request $req, $id){

        $job = JobPost::where('id', $id)
                    //    ->where('vacancy', $vacancy)
                    //    ->where('applicants', $applicants)
                         ->first();
        $v = $job->vacancy;
        $a = $job->applicnts;
        ...
        {
            // echo "==";
            $req->session()->flash('msg', 'Sorry no vacancy left');
            return redirect()->route('recruiter.jobsearch');
            
        }
     
        else if($v < $a ){
            // echo "<";
                    // echo "Sorry no vacancy left";
                    $req->session()->flash('msg', 'Sorry no vacancy left');
                     return redirect()->route('recruiter.jobsearch');
        ...
        // else if($job->vacancy <= $job->applicnts){
        //     // echo "Sorry no vacancy left";
        //     $req->session()->flash('msg', 'Sorry no vacancy left');
        //     return redirect()->route('recruiter.jobsearch');
    ...
    public function jobapply(ApplyRequest $req, $id){
        ...
        //     $document->move('documents/', $documentname);
    ...
    //     return response()->download('documents/' . $document);
    // }
